          ...
          child: IconButton(
            ...
            onPressed: (){
              Navigator.of(context).pop(
                MaterialPageRoute(builder: (BuildContext context) => ThankToView()
                )
              );
            },
          ),
...
30대를 맞이하며 팬들에게 전하는 메세지""",
            ...
            this._detailInfoBody(context)
          ],
        ),
      ),
    );
  }
  Widget _detailInfoBody(BuildContext context){
    return Expanded(
